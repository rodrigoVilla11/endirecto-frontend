...
const NotificationsDetail = ({ notification, closeModal }: any) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-md w-full max-h-[85vh] flex flex-col">
      {/* Header */}
      <div className="flex justify-between items-center p-4 border-b border-gray-200 flex-none">
      ...
      {/* Footer */}
      <div className="flex justify-end gap-3 p-4 border-t border-gray-200 flex-none">
        <button
          onClick={closeModal}
