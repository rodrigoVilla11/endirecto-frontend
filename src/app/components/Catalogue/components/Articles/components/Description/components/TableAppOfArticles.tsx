    ...
    <table className="min-w-full bg-white">
      <thead>
        <tr className="text-xs">
          <th className="py-2  bg-gray-200 text-left">Marca</th>
          <th className="py-2  bg-gray-200 text-left">Modelo</th>
          <th className="py-2  bg-gray-200 text-left">Motor</th>
          <th className="py-2  bg-gray-200 text-left">Año</th>
        </tr>
      </thead>
