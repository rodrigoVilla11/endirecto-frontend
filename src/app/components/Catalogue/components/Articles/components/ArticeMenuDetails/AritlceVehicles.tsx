...
const ArticleVehicle = ({ articleVehicles, closeModal }: ArticleEquivalenceProps) => {
  ...
  return (
    <div className="w-128 z-50 overflow-hidden"> {/* Evita la scrollbar externa */}
      ...
      <div className="max-h-96 overflow-y-auto scrollbar-hide"> {/* Contenedor con desplazamiento oculto */}
