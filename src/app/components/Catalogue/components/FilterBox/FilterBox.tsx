...
const FilterBox = ({ isVisible, onClose }: any) => {
  ...
  return (
    <>
      {isVisible && (
        <div className={`${isMobile ? "w-[100vh] ml-4" : "w-64"} bg-white rounded-lg shadow-lg h-[655px]`}>
          ...
          {(tags.length > 0 || brand || item || vehicleBrand || stock || search) && (
            <div className="px-4 py-2 border-b">
              <h3 className="text-xs font-semibold text-gray-700 mb-2">{t("filtersApplied")}</h3>
