        ...
        <div
          className={
            isMobile
              ...
              : "" // En desktop, puedes dejarlo vacío o colocar otra clase
          }
        >
          <div
            className={`bg-white rounded-lg shadow-2xl overflow-y-auto transition-all duration-300 ${
              isMobile
                ? "w-[80vw] h-[80vh]" // Tamaño y posición centrada en mobile
                : "w-72 h-[655px]" // Ejemplo en desktop (ajusta a tu gusto)
            }`}
          >
            {/* Header with close button */}
            <div className="p-2 flex justify-end items-center border-b sticky top-0 bg-white z-10">
              <button
                onClick={onClose}
