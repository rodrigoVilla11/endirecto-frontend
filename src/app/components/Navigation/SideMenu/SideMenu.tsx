...
const SideMenu = () => {
  ...
  return (
    <div
      ...
      className={`${
        isOpen
          ? `fixed inset-0 w-full h-full z-50 bg-[#0B0B0B]/90 pl-4 sm:relative sm:inset-auto sm:w-72 sm:h-auto sm:z-auto sm:bg-[#0B0B0B]/90`
          : "hidden sm:flex sm:w-16 sm:items-center sm:bg-[#0B0B0B]/90 sm:opacity-100"
